...
\begin{proof}
    В самом деле, наша функция определяется значениями, которые она принимает на $k^n$ наборах. Для каждого набора $k$ значений, а значит, способов выбрать значения $k^{k^n}$.
\end{proof}
...
\begin{enumerate}[nolistsep]
    ...
    \item Дистрибутивности: $(x_1 \vee x_2) \& x_3 = (x_1 \& x_3) \vee (x_2 \& x_3)$, $(x_1 \& x_2) \vee x_3 = (x_1 \vee x_3) \& (x_2 \vee x_3)$, $(x_1 + x_2) \cdot x_3 = x_1 \cdot x_3 + x_2 \cdot x_3 \pmod k$.
