...
\begin{corollary}
    ...
    \[f(x_1, \ldots, x_n) = x_n \cdot f(x_1, \ldots, x_{n - 1}, 1) \vee \overline{x_n} \cdot f(x_1, \ldots, x_{n - 1}, 0).\]
\end{corollary}
