...
\begin{proof}
    ...
    Пусть $s$ --- также натуральный параметр, причём $k, s, \frac{2^k}{s} \to \infty$. Разобьём таблицу на горизонтальные полосы $A_1, \ldots, A_p$ высоты $s$ (полоса $A_p$ имеет высоту $s' \leqslant s$), $p = \ceil{\frac{2^k}{s}}$.
